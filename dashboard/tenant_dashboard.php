    ...
    <i class="fas fa-bars"></i>
        ...
        <div class="section full-width">
            ...
            <?php if ($available_properties && mysqli_num_rows($available_properties) > 0): ?>
                <div class="property-grid">
                    <?php while ($property = mysqli_fetch_assoc($available_properties)): ?>
                        <div class="property-card">
                            ...
                            <p><i class="fas fa-user"></i> Landlord: <?php echo htmlspecialchars($property['landlord_name']); ?></p>
                            <?php if ($has_rent_amount && isset($property['rent_amount'])): ?>
                                <div class="price">$<?php echo number_format($property['rent_amount']); ?>/month</div>
                            <?php endif; ?>
                            <p><i class="fas fa-calendar"></i> Listed: <?php echo date('M j, Y', strtotime($property['created_at'])); ?></p>
                            
                            <div class="property-actions">
                                <a href="property_details.php?id=<?php echo $property['id']; ?>" class="btn btn-view">
                ...
                <div style="text-align: center; margin-top: 20px;">
                    <a href="browse_properties.php" class="btn btn-primary">View All Properties</a>
                </div>
            <?php else: ?>
                <p style="text-align: center; color: #666; padding: 40px;">
                    <i class="fas fa-home" style="font-size: 48px; color: #ccc; margin-bottom: 10px; display: block;"></i>
        ...
        <div class="dashboard-sections">
            ...
            <div class="section">
                        ...
                        <div class="application-item">
                            <div style="display: flex; justify-content: space-between; align-items: start; margin-bottom: 10px;">
                                <div>
                                    ...
                                    <p><i class="fas fa-user"></i> Landlord: <?php echo htmlspecialchars($application['landlord_name']); ?></p>
                                    <p><i class="fas fa-calendar"></i> Applied: <?php echo date('M j, Y', strtotime($application['created_at'])); ?></p>
                                </div>
                ...
                <?php else: ?>
                    <p style="text-align: center; color: #666; padding: 20px;">No applications yet</p>
                <?php endif; ?>
            </div>
